                            ...
                            div { class: "flex gap-16 mb-4",
                                ...
                                div { class: "flex flex-col items-center",
                                    ...
                                    div { class: "flex gap-8",
                                        ...
                                        div { class: "flex flex-col items-center",
                                            div { class: "avatar",
                                                div { class: "w-10 rounded-full ring ring-accent ring-offset-base-100 ring-offset-2",
                                                    img { src: "https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" }
                                                }
                                            }
                                        ...
                                        div { class: "flex items-center gap-3",
                                            div { class: "avatar",
                                                div { class: "mask mask-squircle w-12 h-12",
                                                    img { src: "https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg", alt: "Family Tree" }
                                                }
                                            }
                                            div {
                                ...
                                tr {
                                    td {
                                        div { class: "flex items-center gap-3",
                                            div { class: "avatar",
                                                div { class: "mask mask-squircle w-12 h-12",
                                                    img { src: "https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg", alt: "Project Organization" }
                                                }
                                            }
                                            div {
